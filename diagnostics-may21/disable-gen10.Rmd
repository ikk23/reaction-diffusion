...
## Plot the 4 metrics for a = 0.0688 and 0.07 (why the weird V?)
...
```{r eval=F}
avg_data = read_csv("/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/diagnostics-may21/averaged_csvs/a0.0688_averaged_csv_may_21.csv")
p_increase = 0.52

p = plot_four_stats(avg_data, p_increase, 50, FALSE)
#ggsave(plot = p, filename = "/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/diagnostics-may21/plots/a0.0688_four_metrics_cutoff_gen50.png")
```

```{r}
knitr::include_graphics("../diagnostics-may21/plots/a0.0688_four_metrics_cutoff_gen50.png")
```

### a = 0.07

```{r eval=F}
avg_data = read_csv("/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/diagnostics-may21/averaged_csvs/a0.07_averaged_csv_may_21.csv")
p_increase = 0.58

p = plot_four_stats(avg_data, p_increase, 50, FALSE)
#ggsave(plot = p, filename = "/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/diagnostics-may21/plots/a0.07_four_metrics_cutoff_gen50.png")
```

```{r}
knitr::include_graphics("../diagnostics-may21/plots/a0.07_four_metrics_cutoff_gen50.png")
```