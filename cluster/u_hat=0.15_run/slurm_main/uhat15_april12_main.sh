...
#SBATCH --job-name=uhat15_april12_main
#SBATCH --output=uhat15_april12_main.txt
#SBATCH --array=1-150
...
cp $BASE_DIR/underdom/text_files/uhat15_april12_full_a_run.txt .
...
prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" uhat15_april12_full_a_run.txt`
$prog > ${SLURM_ARRAY_TASK_ID}.part
cp ${SLURM_ARRAY_TASK_ID}.part $BASE_DIR/underdom/out_u15
