...
#SBATCH --job-name=merge_uhat10_april11
#SBATCH --output=merge_uhat10_april11.txt
...
DIR=/home/ikk23/underdom/out_u10
...
cat *.part > uhat10_april11_full_a_run.csv

OUTPUT_DIR=/home/ikk23/underdom/csvs
cp uhat10_april11_full_a_run.csv $OUTPUT_DIR
