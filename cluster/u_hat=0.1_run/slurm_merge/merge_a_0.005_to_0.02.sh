...
#SBATCH --job-name=merge_u10_a_0.005_to_0.02
#SBATCH --output=merge_u10_a_0.005_to_0.02.txt
...
cat *.part > u10_a_0.005_to_0.02.csv

OUTPUT_DIR=/home/ikk23/underdom/csvs
cp u10_a_0.005_to_0.02.csv $OUTPUT_DIR
