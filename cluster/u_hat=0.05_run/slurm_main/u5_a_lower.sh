...
#SBATCH --job-name=u5_a_0.001_to_0.0049
#SBATCH --output=u5_a_0.001_to_0.0049.txt
#SBATCH --array=1-20
...
cp $BASE_DIR/underdom/text_files/u5_lower_a.txt .
...
prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" u5_lower_a.txt`
