get_a_pred_and_a_obs = function(data){
  # data is a summary file with 7 columns: a, sigma, beta, k, u_hat, delta, p_increase
  
  # get the row number of the lowest value of delta. use this to find a_pred and delta_pred
  ind_pred = which.min(data$delta)
