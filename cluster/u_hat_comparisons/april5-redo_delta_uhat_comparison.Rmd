---
title: "uhat comparison after redoing the delta equation"
author: "Isabel Kim"
date: "4/5/2022"
...
```
The observed *a* value that causes P(increase) to be closest to 50% is about 2-2.5x higher than the value of *a* that causes AUC1 to be closest to AUC0.
