...
* The delta value at which P(increase)=100% increases with uhat (a greater increase in AUC is needed for the drive to spread as the frequency threshold gets higher). 
  + But an exception is uhat=40% -- this transition is very sharp and occurs at a very low delta value compared to the other runs'. There could be an issue of not enough data in this region though.
