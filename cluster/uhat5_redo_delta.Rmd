---
title: "Redoing the uhat=5% plots with the correct delta value"
author: "Isabel Kim"
date: "4/5/2022"
...
* Summary csv file from before: `/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.05_run/csvs/uhat_5_u0.001_to_0.02_summary.csv`
...
Edited csv file is at: `/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.05_run/csvs/EDITED_DELTA_uhat_0.05_more_replicate_summary.csv`
...
csv file of delta values predicted for various a values: `/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.05_run/csvs/EDITED_DELTA_a_vs_delta_theoretical.csv`
...
The predicted value of a that would get AUC1 closest to (ab) is `a_star = 0.002026316`, which actually *was* in the cluster runs and led to a P(increase) around 12.5%. 
...
```
* Note: we don't want the value of a that *minimizes* delta (this was a mistake before, can lead us to choose the most negative delta value); we want the value of a that causes delta to be closest to zero.
