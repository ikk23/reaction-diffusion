...
#SBATCH --job-name=vary_a_in_range_u20
#SBATCH --output=vary_a_in_range_u20.txt
#SBATCH --array=1-30
...
cp $BASE_DIR/underdom/slurm_text_a_in_range_u20.txt .
...
prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" slurm_text_a_in_range_u20.txt`
