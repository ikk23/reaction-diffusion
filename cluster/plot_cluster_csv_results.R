...
file = "/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.1_run/csv_raw/uhat10_april11_full_a_run.csv"
...
# Write out 
write_csv(x = summarize_data, file = "/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.1_run/csvs/summary_april11_full_range_uhat10.csv")
...
dir = "/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.1_run/figures/"

# Add line at a of pincrease of 0.5
p = plot_freqs_and_a + geom_vline(xintercept = a_obs, color = "cornsilk3") 
ggsave(filename = paste0(dir,"april12_full_a_vs_p_increase_uhat10.png"),plot=p)

p2 = p + xlim(0,0.1)
ggsave(filename = paste0(dir,"april12_zoomed_in_a_vs_p_increase_uhat10.png"), plot = p2)
...
ggsave(filename = paste0(dir,"april12_full_a_vs_delta_uhat10.png"),plot=plot_a_vs_delta)

# zoom in
p = plot_a_vs_delta + xlim(0,0.1)
ggsave(filename = paste0(dir,"april12_zoomed_in_a_vs_delta_uhat10.png"),plot=p)
...
ggsave(filename=paste0(dir,"april12_delta_vs_p_increase_uhat10.png"),plot = delta_vs_p_increase)
