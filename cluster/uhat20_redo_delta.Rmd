---
title: "Redoing the uhat=20% plots with the correct delta value"
author: "Isabel Kim"
date: "4/5/2022"
...
* Summary csv file from before: `/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.2_run/csvs/uhat_0.2_more_replicate_summary.csv`
...
Edited csv file is at: `Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.2_run/csvs/EDITED_DELTA_uhat_0.2_more_replicate_summary.csv`
...
csv file of delta values predicted for various a values: `/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/cluster/u_hat=0.2_run/csvs/EDITED_DELTA_a_vs_delta_theoretical.csv`
...
```
The predicted value of a that would cause AUC1 to be closest to a*b is a=0.009, which was included in the cluster run (the minimum a; P(increase) was still close to 0).
