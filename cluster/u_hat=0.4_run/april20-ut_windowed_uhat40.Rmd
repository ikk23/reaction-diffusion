...
one_rep = data %>% filter(replicate == 1) %>% ggplot(data = ., aes(x=gen, y = windowed_drive_rate)) + geom_line(color = "red") + xlab("Generations since release") + ylab("Drive rate around x=0") + ggtitle("a = 0.025")

ggsave(plot = one_rep, filename = "/Users/isabelkim/Desktop/lab-meeting/figures/a=0.025_windowed_drive_rate.png")
...
one_rep = data %>% filter(replicate == 1) %>% ggplot(data = ., aes(x=gen, y = windowed_drive_rate)) + geom_line(color = "red") + xlab("Generations since release") + ylab("Drive rate around x=0") + ggtitle("a = 0.0748") + ylim(0,1)
