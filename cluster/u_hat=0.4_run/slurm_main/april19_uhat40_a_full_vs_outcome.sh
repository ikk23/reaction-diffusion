...
#SBATCH --job-name=april19_uhat40_a_full_vs_outcome
#SBATCH --output=april19_uhat40_a_full_vs_outcome.txt
#SBATCH --array=1-250

# Run 250 array jobs, each with 100 replicates
...
cp $BASE_DIR/underdom/text_files/april19_uhat40_full_a_vs_outcome.txt .
...
prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" april19_uhat40_full_a_vs_outcome.txt`
