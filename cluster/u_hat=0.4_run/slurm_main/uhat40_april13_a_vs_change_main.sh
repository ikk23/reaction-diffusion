...
#SBATCH --job-name=uhat40_april13_a_vs_change_main
#SBATCH --output=uhat40_april13_a_vs_change_main.txt
#SBATCH --array=1-200
...
cp $BASE_DIR/underdom/text_files/uhat40_a_vs_dr_change_april13.txt .
...
prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" uhat40_a_vs_dr_change_april13.txt`
