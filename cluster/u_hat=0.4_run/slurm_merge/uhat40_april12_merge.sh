...
#SBATCH --job-name=merge_uhat40_april12
#SBATCH --output=merge_uhat40_april12.txt
...
cat *.part > uhat40_april12_full_a_run.csv

OUTPUT_DIR=/home/ikk23/underdom/csvs
cp uhat40_april12_full_a_run.csv $OUTPUT_DIR
