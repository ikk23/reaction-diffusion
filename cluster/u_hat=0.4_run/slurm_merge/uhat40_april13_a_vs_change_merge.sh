...
#SBATCH --job-name=merge_uhat40_april13_a_vs_change
#SBATCH --output=merge_uhat40_april13_a_vs_change.txt
...
cat *.part > uhat40_april13_a_vs_change.csv

OUTPUT_DIR=/home/ikk23/underdom/csvs
cp uhat40_april13_a_vs_change.csv $OUTPUT_DIR
