---
title: "Check for clustering issues"
author: "Isabel Kim"
date: "6/7/2022"
...
* Divide the 0-1 landscape into 10 cells; check that there's no big clustering issue -- after like 10 generations after the drive drop, the cell population sizes should be ~equal again.
...
The drive still hasn't fixed by the end of the simulation. The count is the highest in the middle 2 cells -- from 0.4 to 0.6. 
