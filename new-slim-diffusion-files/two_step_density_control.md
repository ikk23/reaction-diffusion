...
``` bash
SLIM_CONSOLE=/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/new-slim-diffusion-files/text_out/output.txt
OUTPUT_CSV=/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/new-slim-diffusion-files/csv_out/k_uhat0.2_m100.csv
...
``` r
output = read_csv("/Users/isabelkim/Desktop/year2/underdominance/reaction-diffusion/new-slim-diffusion-files/csv_out/k_uhat0.2_m100.csv")
```
...
![](two_step_density_control_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->

``` r
plot_rate_drive_alleles = ggplot(output, aes(x = gen, y = rate_d_alleles)) + theme_minimal() +
  geom_line(color = "orange") + xlab("gen") + ylab("drive allele frequency") + ggtitle("Drop size of 100 into 30,000 \nuhat=k=0.2") +
  geom_vline(xintercept = 0) + geom_hline(yintercept = 0)
print(plot_rate_drive_alleles) 
```

![](two_step_density_control_files/figure-gfm/unnamed-chunk-18-2.png)<!-- -->
...
![](two_step_density_control_files/figure-gfm/unnamed-chunk-18-3.png)<!-- -->
Good – after the drive is lost, the population size goes back to being
mostly stable.
