...
#SBATCH --job-name=june6_m625
#SBATCH --output=june6_m625.txt
#SBATCH --array=1-4
...
cp $BASE_DIR/underdom/text_files/june6_m625.txt .

# Include SLiM in the path
PATH=$PATH:/home/ikk23/SLiM/SLiM_build
export PATH

prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" june6_m625.txt`
$prog > m625_${SLURM_ARRAY_TASK_ID}.csv
cp m625_${SLURM_ARRAY_TASK_ID}.csv $BASE_DIR/underdom/out_u20
