...
#SBATCH --job-name=june6_m300
#SBATCH --output=june6_m300.txt
#SBATCH --array=1-4
...
cp $BASE_DIR/underdom/text_files/june6_m300.txt .

# Include SLiM in the path
PATH=$PATH:/home/ikk23/SLiM/SLiM_build
export PATH

prog=`sed -n "${SLURM_ARRAY_TASK_ID}p" june6_m300.txt`
$prog > m300_${SLURM_ARRAY_TASK_ID}.csv
cp m300_${SLURM_ARRAY_TASK_ID}.csv $BASE_DIR/underdom/out_u20
